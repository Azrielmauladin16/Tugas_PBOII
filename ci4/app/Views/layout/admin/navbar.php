<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="<?= base_url('admin/news/new') ?>" class="btn btn-primary mr-3">New Post News</a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('admin/product/create') ?>" class="btn btn-primary mr-3">New Post Product</a>
                </li>
                <li class="nav-item">
